...
if(isset($_POST['submit'])){
  ...
  $katalaluan = mysqli_real_escape_string($conn, $_POST['katalaluan']);
   ...
   $select = mysqli_query($conn, "SELECT * FROM `loginpelajar` WHERE  namawarden = '$namawarden'") or die('query failed');

   if(mysqli_num_rows($select) > 0){


      }else{
         $insert = mysqli_query($conn, "INSERT INTO `loginwarden`(namawarden, katalaluanwarden,) VALUES('$namapelajar',  '$katalaluan')") or die('query failed');
    ...
    <a href="login.php" class="nav-link" id="tab-register" data-mdb-toggle="pill" href="#pills-register" role="tab"
      ...
      ?>
                            ...
                            <div class="form-floating">
                              <input type="text"  name="namawarden" class="form-control" placeholder="Username" />
