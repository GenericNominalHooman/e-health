...
if (isset($_POST['submit'])) {
  ...
  if(!$verificationObj->isNameExist($_POST["namawarden"])){
    //Registering warden
    if ($authObj->registerWarden($_POST["namawarden"], $_POST["katalaluan"], "")) {
      // Warden successfully registered
      // Login warden
      $authObj->authWarden($_POST["namawarden"], $_POST["katalaluan"]);
      Redirect::redirect(WARDEN_URL."/Profil/profil.php");
    } else {
      // Warden wasn't successfully registered
      Redirect::redirectWithMsg(WARDEN_URL . "/register.php", "Pendaftaran masuk gagal, tolong maklumkan pentadbir sistem berkaitan isu ini.");
    } 
  } else {
    // Warden wasn't successfully registered
    Redirect::redirectWithMsg(WARDEN_URL . "/register.php", "Sila gunakan nama lain, nama warden tersebut sudah terdapat di dalam sistem.");
  }
}
?>
        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card  shadow-lg card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              ...
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">DAFTAR MASUK WARDEN</h3>

              <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (WARDEN_URL . "/register.php"); ?>" class="nav-link active" id="tab-login" data-mdb-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-login" aria-selected="true">Daftar Masuk</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (WARDEN_URL . "/login.php"); ?>" class="nav-link" id="tab-register" data-mdb-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false">Log Masuk</a>
                </li>
              </ul>
              ...
              <form autocomplete="off" action="register.php" method="post" enctype="multipart/form-data">
                <div class="form-outline mb-4">
                  <div class="form-floating">
                    <input type="text" name="namawarden" class="form-control" placeholder="Nama" />
