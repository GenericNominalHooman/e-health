...
if(isset($_POST['submit'])){
    ...
    $namawarden= mysqli_real_escape_string($conn, $_POST['namawarden']);
    $katalaluan = mysqli_real_escape_string($conn, $_POST['katalaluanwarden']);
 
    $select = mysqli_query($conn, "SELECT * FROM `loginwarden` WHERE namawarden  = '$namawarden' AND katalaluanwarden = '$katalaluan'") or die('query failed');
    if(mysqli_num_rows($select) > 0){
       $row = mysqli_fetch_assoc($select);
       $_SESSION['npenggunaguru'] = $namawarden;
...
?>
     ...
     ?>
                            ...
                            <div class="form-floating">
                              <input type="text" autocomplete="off"  name="namawarden" class="form-control" placeholder="Nama Pengguna" >
