...
if (isset($_POST["submit"])) {
  ...
  if ($authObj->authPentadbir($_POST["namapentadbir"], $_POST["katalaluanpentadbir"])) {
    ...
    Redirect::redirectWithMsg(PENTADBIR_URL . "/login.php", "Kombinasi nama pengguna atau kata laluan yang digunakan adalah salah.");
  }
}
?>
            ...
            <div class="card-body p-4 p-md-5">
              ...
              <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (PENTADBIR_URL . "/register.php"); ?>" class="nav-link" id="tab-login" data-mdb-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-login" aria-selected="true">Daftar Masuk</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (PENTADBIR_URL . "/login.php"); ?>" class="nav-link active" id="tab-register" data-mdb-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false">Log Masuk</a>
                </li>
              </ul>
              ...
              <form action="<?php echo ($_SERVER["PHP_SELF"]); ?>" method="POST">                
                ...
                <div class="form-outline mb-4">
                  <div class="form-floating">
                    <input type="text" autocomplete="off" name="namapentadbir" class="form-control" placeholder="Nama">
                ...
                <div class="form-outline mb-4">
                  <div class="form-floating">
                    ...
                    <label class="form-label" for="katalaluanpentadbir">Kata Laluan</label>
