        ...
        <div class="col-12 col-md-8 mt-4">
            <div class="container-profile-form">
                <div class="card-profile">
                        ...
                        function rerenderProfile(verificationObj) {
                            if (!verificationObj.isEmpty(userLoginArray)) { // User has registered
                                ...
                                let gambarLocation = new ProfileInfoManager({
                                    ...
                                    data: '<?php echo (UPLOADS_URL . "/profile_images" . "/" . $profileImageManger->getProfileImage("pentadbir", $_SESSION["Auth"]["id"])); ?>',
                                });
                    ...
                    <form action="<?php echo(PENTADBIR_URL.'/profil_kemaskini.php');?>" method="post" enctype="multipart/form-data" id="uploadProfil">
                        <div class="forms">
                        </div>
                    </form>
                </div>
                ...
                <div class="card w-100">
                    ...
                    <div class="card-body p-0">
                        <div class="nav nav-sidebar mb-2">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo (PENTADBIR_URL . "/Warden/warden_urus.php"); ?>" class="nav-link" data-abc="true">
                                    <i class='bx bx-list-ol'></i>
                                    Urus Warden
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo (PENTADBIR_URL . "/Guru/guru_urus.php"); ?>" class="nav-link" data-abc="true">
                                    <i class='bx bx-list-ol'></i>
                                    Urus Guru
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo (PENTADBIR_URL . "/Jadual/jadual_guru_urus.php"); ?>" class="nav-link" data-abc="true">
                                    <i class='bx bx-list-ol'></i>
                                    Urus Jadual Guru
                                </a>
                            </li>
                            ...
                            <!-- Reset password -->
                            <li class="nav-item">
                                <a style='color:#172065' href='<?php echo(PENTADBIR_URL."/Profil/tukar_kata_laluan.php");?>' class="nav-link">
    ...
    $(document).ready(function() {
        ...
        savebutton.addEventListener('click', function(e) {
            ...
            if (savebutton.innerHTML == "Kemaskini") {
                ...
                if(userProfileArray != null){ // User has filled out the profile page
                ...
                $.ajax({
                    url: '<?php echo (PENTADBIR_URL . "/Profil/profil_kemaskini.php"); ?>',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
