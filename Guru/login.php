...
if(isset($_POST['submit'])){
    ...
    $katalaluan = mysqli_real_escape_string($conn, $_POST['katalaluanguru']);
 
    $select = mysqli_query($conn, "SELECT * FROM `loginguru` WHERE namaguru  = '$namaguru' AND katalaluanguru = '$katalaluan'") or die('query failed');
...
?>
     ...
     ?>
                            ...
                            <div class="form-floating">
                              <input type="text" autocomplete="off"  name="namaguru" class="form-control" placeholder="Nama Pengguna" >
