...
if (isset($_POST["submit"])) {
  //auth perlu ditukar
  if ($authObj->authGuru($_POST["namaguru"], $_POST["katalaluanguru"])) {
    // Redirect user to the profile page
    Redirect::redirect(GURU_URL . "/Profil/profil.php");
  } else {
    Redirect::redirectWithMsg(GURU_URL . "/login.php", "Kombinasi nama pengguna atau kata laluan yang digunakan adalah salah.");
  }
}
?>
        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-lg card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              ...
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">LOG MASUK GURU</h3>

              <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (GURU_URL . "/register.php"); ?>" class="nav-link" id="tab-login" data-mdb-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-login" aria-selected="true">Daftar Masuk</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a href="<?php echo (GURU_URL . "/login.php"); ?>" class="nav-link active" id="tab-register" data-mdb-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false">Log Masuk</a>
                </li>
              </ul>
              ...
              <form action="<?php echo ($_SERVER["PHP_SELF"]); ?>" method="POST">                
                ...
                <div class="form-outline mb-4">
                  <div class="form-floating">
                    <input type="text" autocomplete="off" name="namaguru" class="form-control" placeholder="Nama">
                ...
                <div class="form-outline mb-4">
                  <div class="form-floating">
                    <input type="password" id="password" name="katalaluanguru" class="form-control" placeholder="Kata Laluan">
                    <label class="form-label" for="katalaluanguru">Kata Laluan</label>
