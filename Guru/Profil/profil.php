        ...
        <div class="col-12 col-md-8 mt-4">
            <div class="container-profile-form">
                <div class="card-profile">
                    <div class="info"> <span class="h3 font-weight-bold">PROFIL</span> <button id="savebutton">Kemaskini</button> </div>
                    ...
                    if ($authObj->isAuth()) {
                        ...
                        $userProfile = $profilModel->getAllGuruWhere("id_login", $_SESSION["Auth"]["id"]);
                        ...
                        function rerenderProfile(verificationObj) {
                            if (!verificationObj.isEmpty(userLoginArray)) { // User has registered
                                ...
                                let gambarLocation = new ProfileInfoManager({
                                    ...
                                    data: '<?php echo (UPLOADS_URL . "/profile_images" . "/" . $profileImageManger->getProfileImage("guru", $_SESSION["Auth"]["id"])); ?>',
                                });
                                ...
                                if (!verificationObj.isEmpty(userProfileArray)) {
                                    let program = new ProfileInfoManager({
                                        title: 'Program',
                                        post_name: 'program',
                                        data: userProfileArray[0]['programguru'],
                                    });
                                    ...
                                    profileHTML += program.render() + no_kp.render() + no_telefon.render() + no_plat.render();
                ...
                <div class="card w-100">
                    ...
                    <div class="card-body p-0">
                        <div class="nav nav-sidebar mb-2">
                            ...
                            <!-- Reset password -->
                            <li class="nav-item">
                                <a style='color:#172065' href='<?php echo(GURU_URL."/Profil/tukar_kata_laluan.php");?>' class="nav-link">
    ...
    $(document).ready(function() {
        ...
        savebutton.addEventListener('click', function(e) {
            ...
            if (savebutton.innerHTML == "Kemaskini") {
                ...
                $.ajax({
                    url: '<?php echo (GURU_URL . "/Profil/profil_kemaskini.php"); ?>',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
